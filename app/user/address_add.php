    ...
    <script>
        ...
        function idachuapplogin(str){
            $('#save_btn').do_action({
                ...
                data: {auth: str, forward: 'http://www.idachu.cn/user/address/add'},
...
<div class="container" id="setting">
    ...
    <div class="panel panel-default">
        ...
        <ul class="list-group">
            <li class="list-group-item edit_controll"><span class="alt">小区 <span class="required">*</span></span><input type="text" class="input" id="community" value="" placeholder="例如三里屯北小区"/></li>
            <li class="list-group-item edit_controll"><span class="alt">门牌号 <span class="required">*</span></span><input type="text" class="input" id="door_number" value="" placeholder="例如1号楼501"/></li>
        </ul>
    </div>
    <select id="area">
